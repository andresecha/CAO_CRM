...
#                            The i18n overlays are compiled by
#                            docs/i18n/scripts/compile_i18n_overlay.py, which writes its own
#                            "NOT PART OF THE OFFICIAL SOURCES" header -- the glob covers
#                            every language's overlay, not just the fr/es one
#  - docs/i18n/review/*      review documents generated by build_review_doc.py and sent to
#                            native speakers; working material, gitignored, not published
...
FILES=$(find . \
  \( -path ./.venv -o -path ./.git -o -path ./.tools -o -path ./docs/.tools \
     -o -path ./docs/site -o -path ./imports/vendor -o -path ./docs/i18n/review \
